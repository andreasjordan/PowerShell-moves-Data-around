...
# first shipment 120. Demos 04 and 06 are empty until then, and that looks broken when it is not.
Write-Warning 'demos 04 and 06 need the photoservice application to have been running for two minutes'
